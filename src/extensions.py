...
try:
    ...
    logger.logger(f"f"Failed to initialize Sentry: {e}")
...
def init_extensions(app):
    ...
    try:
        ...
        logger.logger(f"f"Failed to initialize rate limiter: {e}")
...
def _get_sync_session_factory():
    ...
    try:
        ...
        logger.logger(f"f"Failed to create sync session factory: {e}")
        return None
