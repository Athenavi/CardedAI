...
async def get_maintenance_status_api(
    ...
    try:
        ...
        logger.logger(f"Error in get_maintenance_status_api: {str(e)}")
...
async def enable_maintenance_api(
    ...
    try:
        ...
        logger.logger(f"Error in enable_maintenance_api: {str(e)}")
        logger.logger(f"traceback.format_exc())
        return ApiResponse(success=False, error=str(e))
...
async def disable_maintenance_api(
    ...
    try:
        ...
        logger.logger(f"Error in disable_maintenance_api: {str(e)}")
        logger.logger(f"traceback.format_exc())
        return ApiResponse(success=False, error=str(e))
...
async def schedule_maintenance_api(
    ...
    try:
        ...
        logger.logger(f"Error in schedule_maintenance_api: {str(e)}")
        logger.logger(f"traceback.format_exc())
        return ApiResponse(success=False, error=str(e))
...
async def add_whitelist_ip_api(
    ...
    try:
        ...
        import traceback
        logger.logger(f"Error in add_whitelist_ip_api: {str(e)}")
...
async def remove_whitelist_ip_api(
    ...
    try:
        ...
        logger.logger(f"Error in remove_whitelist_ip_api: {str(e)}")
        logger.logger(f"traceback.format_exc())
        return ApiResponse(success=False, error=str(e))
...
async def update_message_api(
    ...
    try:
        ...
        logger.logger(f"Error in update_message_api: {str(e)}")
        logger.logger(f"traceback.format_exc())
        return ApiResponse(success=False, error=str(e))
