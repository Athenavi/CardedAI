...
async def get_internal_link_suggestions_api(
    ...
    try:
        ...
        import traceback
        logger(f"Error in get_internal_link_suggestions_api: {str(e)}")
...
async def detect_orphan_articles_api(
    ...
    try:
        ...
        import traceback
        logger(f"Error in detect_orphan_articles_api: {str(e)}")
        logger(traceback.format_exc())
        return ApiResponse(success=False, error=str(e))
...
async def internal_link_analysis_api(
    ...
    try:
        ...
        import traceback
        logger(f"Error in internal_link_analysis_api: {str(e)}")
        logger(traceback.format_exc())
        return ApiResponse(success=False, error=str(e))
