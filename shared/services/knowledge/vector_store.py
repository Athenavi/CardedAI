...
class MilvusBackend(VectorStoreBackend):
    ...
    async def _get_client(self):
        ...
        if self._client is None:
            try:
                ...
                logger.logger(f"f"Milvus 连接失败: {e}")
                raise
        return self._client
    ...
    async def create_collection(self, collection_name: str, dimension: int = 1536,
        ...
        try:
            ...
            logger.logger(f"f"Milvus 创建集合失败: {e}")
            return False
    ...
    async def insert(self, collection_name: str, vectors: List[List[float]],
        ...
        try:
            ...
            logger.logger(f"f"Milvus 插入失败: {e}")
            return []
    ...
    async def search(self, collection_name: str, query_vector: List[float],
        ...
        try:
            ...
            logger.logger(f"f"Milvus 搜索失败: {e}")
            return []
    ...
    async def delete(self, collection_name: str, ids: List[str]) -> bool:
        try:
            ...
            logger.logger(f"f"Milvus 删除失败: {e}")
            return False
    ...
    async def drop_collection(self, collection_name: str) -> bool:
        try:
            ...
            logger.logger(f"f"Milvus 删除集合失败: {e}")
            return False
    ...
    async def get_collection_info(self, collection_name: str) -> Optional[Dict[str, Any]]:
        try:
            ...
            logger.logger(f"f"Milvus 获取集合信息失败: {e}")
            return None
...
class QdrantBackend(VectorStoreBackend):
    ...
    async def create_collection(self, collection_name: str, dimension: int = 1536,
        ...
        try:
            ...
            logger.logger(f"f"Qdrant 创建集合失败: {e}")
            return False
    ...
    async def insert(self, collection_name: str, vectors: List[List[float]],
        ...
        try:
            ...
            logger.logger(f"f"Qdrant 插入失败: {e}")
            return []
    ...
    async def search(self, collection_name: str, query_vector: List[float],
        ...
        try:
            ...
            logger.logger(f"f"Qdrant 搜索失败: {e}")
            return []
    ...
    async def delete(self, collection_name: str, ids: List[str]) -> bool:
        try:
            ...
            logger.logger(f"f"Qdrant 删除失败: {e}")
            return False
    ...
    async def drop_collection(self, collection_name: str) -> bool:
        try:
            ...
            logger.logger(f"f"Qdrant 删除集合失败: {e}")
            return False
    ...
    async def get_collection_info(self, collection_name: str) -> Optional[Dict[str, Any]]:
        try:
            ...
            logger.logger(f"f"Qdrant 获取集合信息失败: {e}")
            return None
...
class LocalBackend(VectorStoreBackend):
    ...
    async def create_collection(self, collection_name: str, dimension: int = 1536,
        ...
        try:
            ...
            logger.logger(f"f"本地向量集合创建失败: {e}")
            return False
    ...
    async def drop_collection(self, collection_name: str) -> bool:
        try:
            ...
            logger.logger(f"f"本地向量集合删除失败: {e}")
            return False
    ...
    async def get_collection_info(self, collection_name: str) -> Optional[Dict[str, Any]]:
        try:
            ...
            logger.logger(f"f"本地向量集合信息获取失败: {e}")
            return None
