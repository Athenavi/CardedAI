...
class IncrementalBackupService:
    ...
    def _load_metadata(self) -> Dict[str, Any]:
        ...
        if self.metadata_file.exists():
            try:
                ...
                logger(f"[IncrementalBackup] Failed to load metadata: {e}")
                return {}
        return {}
    ...
    def _save_metadata(self):
        ...
        try:
            ...
            logger(f"[IncrementalBackup] Failed to save metadata: {e}")
    ...
    async def create_incremental_backup(
        ...
        try:
            ...
            logger(f"[IncrementalBackup] Error creating incremental backup: {e}")
            import traceback
            traceback.print_exc()
            return {
                'success': False,
    ...
    async def create_differential_backup(
        ...
        try:
            ...
            logger(f"[IncrementalBackup] Error creating differential backup: {e}")
            return {
                'success': False,
                'error': str(e)
            }
    ...
    async def restore_incremental_backup(
        ...
        try:
            ...
            logger(f"[IncrementalBackup] Error restoring backup chain: {e}")
            return {
                'success': False,
                'error': str(e)
            }
    ...
    async def _detect_changed_tables(
        ...
        try:
            ...
            logger(f"[IncrementalBackup] Error detecting changed tables: {e}")
            # 出错时返回所有表以确保数据安全
            return tables or []
    ...
    async def _calculate_tables_checksum(
        ...
        try:
            ...
            logger(f"[IncrementalBackup] Error calculating checksums: {e}")
            return {}
    ...
    async def _perform_incremental_dump(
        ...
        try:
            ...
            logger(f"[IncrementalBackup] Error performing dump: {e}")
            return {
                'success': False,
                'error': str(e)
            }
    ...
    async def _restore_single_backup(
        ...
        try:
            ...
            logger(f"[IncrementalBackup] Error restoring backup: {e}")
            return {
                'success': False,
                'error': str(e)
            }
            ...
            if filename:
                ...
                if backup_path.exists():
                    try:
                        ...
                        logger(f"[IncrementalBackup] Failed to delete {filename}: {e}")
