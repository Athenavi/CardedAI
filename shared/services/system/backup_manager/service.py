...
class BackupService:
    ...
    def restore_backup(self, backup_name: str, restore_files: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"[BackupService] Restore failed: {e}")
            return {'success': False, 'error': str(e)}
    ...
    def _file_has_changed(self, file_path: Path) -> bool:
        ...
        try:
            ...
            logger.error(f"[BackupService] Failed to check file changes: {e}")
            return True
...
async def create_full_backup(db: AsyncSession) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"[BackupService] JSON backup failed: {e}")
        return {'success': False, 'error': str(e)}
