...
class LocalizationService:
    ...
    def convert_to_user_timezone(self, dt: datetime,
        ...
        try:
            ...
            logger.logger(f"f"Failed to convert timezone: {str(e)}")
            return dt
    ...
    def format_date(self, dt: datetime, locale: str = 'en-US',
        ...
        try:
            ...
            logger.logger(f"f"Failed to format date: {str(e)}")
    ...
    def format_datetime(self, dt: datetime, locale: str = 'en-US',
        ...
        try:
            ...
            logger.logger(f"f"Failed to format datetime: {str(e)}")
    ...
    def get_timezone_offset(self, timezone_name: str) -> str:
        ...
        try:
            ...
            logger.logger(f"f"Failed to get timezone offset: {str(e)}")
            return '+00:00'
